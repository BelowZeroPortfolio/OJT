-- Supabase Real-time Migration Script
-- Run this script in your Supabase SQL Editor to enable real-time functionality
...
-- Grant insert/update permissions for attendance records
...
AND tablename IN ('attendance_records', 'users', 'locations');
