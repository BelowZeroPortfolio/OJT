...
<div x-data="adminDashboard()" x-init="startPolling()">
    ...
    <div class="bg-destructive/10 border border-destructive/20 rounded-lg p-4 mb-6">
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-destructive mb-1">Error Loading Dashboard</h3>
        ...
        <div class="p-4 flex items-center justify-between">
            <div class="flex items-center gap-3 flex-1">
                <button @click="showFilters = !showFilters" 
                        type="button"
                        class="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-foreground bg-secondary hover:bg-accent hover:text-accent-foreground rounded-lg transition-colors">
